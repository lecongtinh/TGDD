<?php
	...
	$direct = "index.php?option=";
		if(isset($_POST["iddmspc"]) == ""){
			//Tra vi tri ban dau khi khong click de loc san pham
			?>
				<?php
                    include_once($_SERVER['DOCUMENT_ROOT'].'/TGDD/Models/SanPham.php');
                                ...
                                <td>
                                    <?php 
                                        if (mysql_num_rows($dssp_xemnhieu) > 0) {
                                            ...
                                            }//Het doan tra ve vi tri ban dau
                                        } else {
                                            echo "<tr><td class='khongdulieu' colspan='11'>Không có dữ liệu</td></tr>";
                                        }
                                    ?>
                                  </td>
                              </tr>
        ...
        $iddm = $_POST["iddmspc"];
        $sp = new SanPham();
        $result = $sp->getSanPhamTheoDM($iddm);
        ?>
        <div class="wrap3" id="cotphai">
        <div class="benphai">
            <div class="box1">
            <div class="box-heading1"><?php echo "Sản phẩm theo danh mục được chọn" ?></div>
              <table width="700" border="1" cellpadding="0" cellspacing="0" class="TableSanPham">
                <tr>
                    <td>
                        <?php
